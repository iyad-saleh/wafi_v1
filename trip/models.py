...
class Trip(models.Model):
    ...
    driver1   = models.ForeignKey(Driver, null=True,blank=True, on_delete=models.SET_NULL,related_name='Bus_Driver'  )
    driver2   = models.ForeignKey(Driver, null=True,blank=True, on_delete=models.SET_NULL, related_name='BusDriverHelp'  )
...
class flight_trip(models.Model):
    ...
    cityFrom  = models.ForeignKey(Location,on_delete=models.CASCADE ,null=True,blank=True, related_name='CITY_FROM_flight')
    cityTo    =  models.ForeignKey(Location,on_delete=models.CASCADE, null=True,blank=True, related_name='CITY_TO_flight')
    start_time =  models.DateTimeField()
    end_time  = models.DateTimeField( null=True,blank=True)
